...
const Tile = ({ evedet }: any) => {
  ...
  return (
    <div
      ref={ani}
      className="transition-[transform,_opacity] translate-y-[100px] duration-300 opacity-0 w-full   flex-col flex   rounded-2xl overflow-hidden bg-[#D3BAFF] backdrop-blur-[8px] bg-opacity-10 shadow-extrasoft border border-1 border-[#575F8E]"
      onMouseOver={() => {
        setGlow(true);
      }}
      onMouseLeave={() => {
