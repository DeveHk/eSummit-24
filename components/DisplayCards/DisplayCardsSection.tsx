...
const DisplayCardsSection = (props: Props) => {
  ...
  return (
    <div
      className="relative z-[2] max-w-screen min-h-screen overflow-x-hidden overflow-y-hidden"
      onPointerMove={(e) => {
    ...
    >
      ...
      <div className="absolute top-0 z-[1] backdrop-blur-[12vmax] h-full w-full bg-black bg-opacity-10"></div>
      <div
        ref={blobRef}
